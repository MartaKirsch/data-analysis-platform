...
def test_rantree(client):
    response = client.post("/calculate/1", data={
        "calculationType": "random_forest",
...
def test_rantree_few_columns(client):
    response = client.post("/calculate/1", data={
        "calculationType": "random_forest",
        "classes": "X",
...
def test_rantree_few_rows(client):
    response = client.post("/calculate/1", data={
        "calculationType": "random_forest",
        "classes": "Customer_Segment",
...
def test_rantree_wrong_datatype(client):
    response = client.post("/calculate/1", data={
        "calculationType": "random_forest",
