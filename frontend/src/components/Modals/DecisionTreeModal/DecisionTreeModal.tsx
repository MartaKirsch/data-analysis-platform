...
import {
  DecisionTreeModalBody,
  DecisionTreeModalInnerBody,
  DecisionTreeModalSelectWrapper,
} from "./DecisionTreeModal.components";
...
const DecisionTreeModal: FC<DecisionTreeModalProps> = ({
  onClose,
  file,
  parameters,
  id,
